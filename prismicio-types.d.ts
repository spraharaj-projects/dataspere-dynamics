...
interface BlogPostDocumentData {
  ...
  /**
   * Repository Link field in *Blog Post*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: blog_post.repository_link
   * - **Tab**: Main
...
interface ProjectDocumentData {
  ...
  /**
   * Repository Link field in *Project*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project.repository_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  repository_link: prismic.LinkField;
...
interface SettingsDocumentData {
  ...
  /**
   * Colab Link field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.colab_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  colab_link: prismic.LinkField;
